...
RSpec.describe ApplicationHelper, type: :helper do
  describe "when expected in Fahrenheit" do
    ...
    it "converts temps from C to F" do
      expect(convert_temp(10)).to eq(50)
    end

    # dds are stored internally as F
    it "keeps dds in F" do
      expect(convert_dds(100)).to eq(100)
    end
  ...
  describe "when expected in Celcius" do
    ...
    it "keeps temps in C" do
      expect(convert_temp(10)).to eq(10)
    end

    # dds are stored internally as F
    it "converts dds from F to C" do
      expect(convert_dds(50).round(1)).to eq(27.8)
    end
