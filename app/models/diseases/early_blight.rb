class EarlyBlight < Disease
  ...
  def total_to_severity(total, avg7)
    if total >= 400
      ...
      return 4 if total >= 350
      return 3 if total >= 300
      return 2 if total >= 250
      return 1 if total >= 200
    end
    0
  rescue
    nil
  ...
  def severity_legend
    [
      {value: 0, name: "Very Low", description: "Very low likelihood of disease (accumulated P-days < 200 or 7-day average < 1)"},
      ...
      {value: 3, name: "High", description: "High likelihood of disease (accumulated P-days 350-400 or 7-day average 5-9/day)"},
      {value: 4, name: "Very High", description: "Very high likelihood of disease (accumulated P-days >400 and 7-day average >9/day)"}
    ]
  end
