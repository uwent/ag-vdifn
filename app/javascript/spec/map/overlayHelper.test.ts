...
it('maps gradient to severity values', () => {
  ...
  let result = overlayHelper.severityToColor(50, gradientMapping)
  expect(result).toEqual('#00cc00')

  result = overlayHelper.severityToColor(125, gradientMapping)
  expect(result).toEqual('#ffd700')

  result = overlayHelper.severityToColor(175, gradientMapping)
  expect(result).toEqual('#ee8f00')

  result = overlayHelper.severityToColor(800, gradientMapping)
  expect(result).toEqual('#00cc00')
})
