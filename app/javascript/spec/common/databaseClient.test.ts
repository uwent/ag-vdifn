...
import { PointDetailsParams, SeverityParams, StationDetailsParams } from '../../src/components/common/TypeScript/types'
...
describe("fetchPestInfo", () => {
    ...
    it('returns empty object on failure', async () => {
        ...
        expect(response).toEqual({ info: null, name: null, pest_link: null, biofix_date: null, end_date_enabled: null, tmin: null, tmax: null })
    })
})
