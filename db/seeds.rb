...
oak_wilt = OakWilt.create!(
  ...
  severity_info: "Oak Wilt transmission risk begins at 5% beetle flight (128.3 FDD) and remains elevated through 95% beetle flight (2343.5 FDD). Extreme risk occurs during the 25%-75% beetle flight period (215.8-1461.8 FDD). Wounding, pruning, or harvesting oaks should be avoided during this period of elevated transmission risk.",
  photo: "oak_wilt.png",
