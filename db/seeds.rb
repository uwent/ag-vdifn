...
colorado_potato_beetle = DegreeDayPest2.create!(
  ...
  severity_info: "Adjust biofix date to match date of first egg mass discovery. Overwintering adults lay eggs around 120 FDD after the biofix, with peak larvae and feeding occurring around 400 FDD. First generation feeding ends around 675 FDD. Secon generation adults can cause severe damage, appearing around 900 FDD, peaking around 1400 FDD, and dispersing to overwintering habitats by around 1800 FDD.",
